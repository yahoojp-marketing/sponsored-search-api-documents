# CampaignSharedSetValues
CampaignSharedSetValuesは、get/mutateメソッドの実行結果（1エンティティ）を保持するオブジェクトです。
...
<table>
 ...
 <tr>
  ...
  <td>キャンペーンと対象外キーワード リストの関連付け1件あたりの</br>get/mutateメソッドの実行結果です。</td>
  <td>yes</td>
  <td>-</td>
  <td>-</td>
  <td>-</td>
