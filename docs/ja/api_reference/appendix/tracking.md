...
| unescapedlpurl | lpurl（最終リンク先URL）を含むトラッキングURLで、lpurlをエンコードしない場合に利用できます。 |・最終リンク先URL：<br>http://www.yahoo.co.jp/?param=1<br>・トラッキングURL：<br>{unescapedlpurl}&param2=2<br>・広告クリック後のURL：<br>http://www.yahoo.co.jp/?param=1&param2=2 |
