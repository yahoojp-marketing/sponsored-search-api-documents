# FeedFolderPlaceholderField (enum)
...
| DYNAMIC_AD_FOR_SEARCH_PAGE_FEEDS_PAGE_URL| string| Page url of Dynamic ad for search page feeds. |
| DYNAMIC_AD_FOR_SEARCH_PAGE_FEEDS_LABEL| string| Label of Dynamic ad for search page feeds.  |
