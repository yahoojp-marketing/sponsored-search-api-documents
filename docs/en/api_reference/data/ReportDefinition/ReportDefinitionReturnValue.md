...
| ----- | ---- | ----------- | -------- | --------- | --------- | --------- | --------- |
| values[0...30] | [ReportDefinitionValues](./ReportDefinitionValues.md) | Result of mutate method regarding report details.<br/>Each list includes report details. | yes | - | - | - | - | |
