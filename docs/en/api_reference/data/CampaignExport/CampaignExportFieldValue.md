# CampaignExportFieldValue
CampaignExportFieldValue object contains the results (list of all entities) for getExportFields method.
...
<table>
 ...
 <tr>
  ...
  <td>The result of getExportFields method</td>
  <td>yes</td>
  <td>-</td>
  <td>-</td>
  <td>-</td>
