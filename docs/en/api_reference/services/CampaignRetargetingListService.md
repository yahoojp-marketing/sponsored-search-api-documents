...
|---|---|---|---|
| selector | Req | [CampaignRetargetingListSelector](../data/CampaignRetargetingListSelector.md) | Retains search criteria (exec parameters) on get method.| 
...
|---|---|---|
| rval | [CampaignRetargetingListPage](../data/CampaignRetargetingListPage.md) | Retains the exec result (list of all entities) of get method | 
...
| Parameter | Restrictions | Data type | Description|
|---|---|---|---|
| operations | Req | [CampaignRetargetingListOperation](../data/CampaignRetargetingListOperation.md) | Retains the target list to be operated on mutate method including operation result.| 
...
| Field | Data type | Description | 
|---|---|---|
| rval | [CampaignRetargetingListReturnValue](../data/CampaignRetargetingListReturnValue.md) | Retains the exec result (list of all entities) of mutate method. | 
    ...
    <SOAP-ENV:Body>
        <ns1:mutate>
            <ns1:operations>
                ...
                <!-- Revised from 'Exclude' to 'Include' -->
                <ns1:operand>
                    <ns1:accountId>100000001</ns1:accountId>
                    <ns1:campaignId>100000002</ns1:campaignId>
                    <ns1:criterionTargetList>
