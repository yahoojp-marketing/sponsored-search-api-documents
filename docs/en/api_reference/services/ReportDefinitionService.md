...
| environment | url |
|---|---|
| production  | https://ss.yahooapis.jp/services/V201808/ReportDefinitionService?wsdl|
| sandbox  | https://sandbox.ss.yahooapis.jp/services/V201808/ReportDefinitionService?wsdl|

#### Namespace
http://ss.yahooapis.jp/V201808/ReportDefinition
...
- Up to 30 definitions for a scheduled report can be added as a template for each regular or proxy authentications.
...
|---|---|---|---|
| selector | Req | [ReportDefinitionSelector](../data/ReportDefinition/ReportDefinitionSelector.md) | Report definition relate to the operations to apply. |

##### Request Sample
```xml
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
  <SOAP-ENV:Header>
    <RequestHeader xmlns="http://ss.yahooapis.jp/V201808/ReportDefinition" xmlns:ns2="http://ss.yahooapis.jp/V201808">
  ...
  <SOAP-ENV:Body>
    <get xmlns="http://ss.yahooapis.jp/V201808/ReportDefinition" xmlns:ns2="http://ss.yahooapis.jp/V201808">
      <selector>
...
|---|---|---|
| rval | [ReportDefinitionPage](../data/ReportDefinition/ReportDefinitionPage.md) | Entry of report definitions to be generated. |

##### Response Sample
```xml
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
  <SOAP-ENV:Header>
    <ResponseHeader xmlns="http://ss.yahooapis.jp/V201808/ReportDefinition" xmlns:ns2="http://ss.yahooapis.jp/V201808">
      <ns2:service>ReportDefinition</ns2:service>
      <ns2:requestTime>1523506336828</ns2:requestTime>
      <ns2:timeTakenSeconds>0.2671</ns2:timeTakenSeconds>
    </ResponseHeader>
  </SOAP-ENV:Header>
  <SOAP-ENV:Body>
    <ns2:getResponse xmlns="http://ss.yahooapis.jp/V201808" xmlns:ns2="http://ss.yahooapis.jp/V201808/ReportDefinition">
      <ns2:rval>
...
| Parameter | Restrictions | Data Type | Description |
|---|---|---|---|
|reportType | Req | enum [ReportType](../data/ReportDefinition/ReportType.md) | Type of report. |
...
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <SOAP-ENV:Body>
    <getReportFields xmlns="http://ss.yahooapis.jp/V201808/ReportDefinition">
...
| Field | Data Type | Description |
|---|---|---|
| rval | [ReportDefinitionFieldValue](../data/ReportDefinition/ReportDefinitionFieldValue.md) | Entry of available report fields list. |
...
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
  <SOAP-ENV:Header>
    <ResponseHeader xmlns="http://ss.yahooapis.jp/V201808/ReportDefinition" xmlns:ns2="http://ss.yahooapis.jp/V201808">
      <ns2:service>ReportDefinition</ns2:service>
      <ns2:requestTime>1523506336865</ns2:requestTime>
      <ns2:timeTakenSeconds>0.2671</ns2:timeTakenSeconds>
    </ResponseHeader>
  </SOAP-ENV:Header>
  <SOAP-ENV:Body>
    <ns2:getReportFieldsResponse xmlns="http://ss.yahooapis.jp/V201808" xmlns:ns2="http://ss.yahooapis.jp/V201808/ReportDefinition">
      <ns2:rval>
        <ns2:fields>
...
| Parameter | Restrictions | Data type | Description |
|---|---|---|---|
| operation | Req | [ReportDefinitionOperation](../data/ReportDefinition/ReportDefinitionOperation.md) | Report definitions and operation details to be processed. |
...
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <SOAP-ENV:Body>
    <mutate xmlns="http://ss.yahooapis.jp/V201808/ReportDefinition">
      <operations>
...
| Field | Data Type | Description |
|---|---|---|
| rval | [ReportDefinitionReturnValue](../data/ReportDefinition/ReportDefinitionReturnValue.md) | Container for report definition including operation results. |
...
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
  <SOAP-ENV:Header>
    <ResponseHeader xmlns="http://ss.yahooapis.jp/V201808/ReportDefinition" xmlns:ns2="http://ss.yahooapis.jp/V201808">
      <ns2:service>ReportDefinition</ns2:service>
      <ns2:requestTime>1523506336850</ns2:requestTime>
      <ns2:timeTakenSeconds>0.2671</ns2:timeTakenSeconds>
    </ResponseHeader>
  </SOAP-ENV:Header>
  <SOAP-ENV:Body>
    <ns2:mutateResponse xmlns="http://ss.yahooapis.jp/V201808" xmlns:ns2="http://ss.yahooapis.jp/V201808/ReportDefinition">
      <ns2:rval>
...
<SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/">
  <SOAP-ENV:Header>
    <ResponseHeader xmlns="http://ss.yahooapis.jp/V201808/ReportDefinition" xmlns:ns2="http://ss.yahooapis.jp/V201808">
      <ns2:service>ReportDefinition</ns2:service>
      <ns2:requestTime>1523506336885</ns2:requestTime>
      <ns2:timeTakenSeconds>0.2671</ns2:timeTakenSeconds>
    </ResponseHeader>
  </SOAP-ENV:Header>
  <SOAP-ENV:Body>
